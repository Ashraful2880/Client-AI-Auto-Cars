    ...
    return (
        <div className="success-bg">
                <div className="row container mx-auto pt-4">
                    <div className="col-sm-6 col-md-3 col-lg-3 py-4 rounded-3 mx-auto mb-2 award-container" data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine">
                    ...
                    <div className="col-sm-6 col-md-3 col-lg-3 py-4 rounded-3 mx-auto mb-2 award-container" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
